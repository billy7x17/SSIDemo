...
<div class="rightDisplayFwSj"> 
	<div class="formGroup">	
	   ...
	   <form id="mainForm" method="post" action="editSite.action" > 
			<table class="addTable" align="center" cellpadding="0" cellspacing="0" >
				   ...
				   <td class="tdInput" valign="top">
				     <input type="text" id="siteName" name="site.siteName" value="<s:property value="site.siteName"/>" class="input" maxlength="20"/>
				     <input type="hidden" id="siteId" name="site.siteId" value="<s:property value="site.siteId"/>" />
				   </td>
				...
				<tr>
				   ...
				   <td  class="tdInput" valign="top">        
				        <textarea name="site.description" id="desc" class="newTextarea" onkeydown="validateTextarea();" onkeyup="validateTextarea();"><s:property value="site.description"/> </textarea>
				    </td>
...
$(function(){
	 $("#lineNum").val('<s:property value="site.lineNum"/>');
	 $("#siteType").val('<s:property value="site.siteType"/>');
