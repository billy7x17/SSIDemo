...
<div class="rightDisplayFwSj"> 
   <div class="formGroup">  	
     ...
     <form id="mainForm" method="post" action="zoneAdd.action" > 
            ...
            <tr>
	           ...
	           <td class="tdInput" valign="top">
	             <input type="text" id="zoneName" name="room.zoneName" class="input" maxlength="20"/>
	           </td>
		 ...
		 <tr>  
	       <s:if test="roleType==2">
	        ...
	        <td class="tdInput" valign="top" style="color: #666;">
	         	...
	         	<%-- <s:hidden id="room.siteId" name="siteId"/> --%>
	         	<input type="text"  id="siteId" value="<s:property value="siteId"/>" name="room.siteId" style="display: none;"/>
	        </td>
	       </s:if>
	       <s:else>
	       <td class="tdLabel" align="right" valign="top"><s:text name="common.red.point"/> <s:text name="resource.zone.siteName"/><s:text name="common.lable.point"/></td>
        	...
        	<td class="tdVad" valign="top"><div id="siteIdTip"></div> </td>
		     ...
		     <tr>
		        ...
		        <td class="tdInput" valign="top">
		       	    <input type="text" id="principal" name="room.principal"  class="input" maxlength="20"/>
		        </td>
		     ...
		     <tr>
		        ...
		        <td  class="tdInput" valign="top">
		         	<input type="text" id="address" name="room.address" class="input" maxlength="50">
		         </td>
			 ...
			 <tr>
		         ...
		         <td  class="tdInput" valign="top">        
	                  <textarea name="room.description" id="desc" class="newTextarea" onkeydown="validateTextarea();" onkeyup="validateTextarea();"></textarea>
		         </td>
   ...
   <!--滚动条 scroll end-->
	...
	<div class="serverEventButton">
	    <ul class="rightToolButtonjhjFwSj">
	        ...
	        <li><a href="zoneResourceInit.action" class="buttonGrey" ><s:property value="getText('common.button.cancel')" /></a></li>
	    </ul>
	</div>
</div>              