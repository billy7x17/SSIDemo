...
<div class="rightDisplayFwSj">
   <div class="formGroup">
	 ...
	 <form id='mainForm' name="mainForm" method="post" action="clusterAdd.action" > 
        <table class="addTable" align="center" cellpadding="0" cellspacing="0" >
         	<tr>
		        ...
		        <td class="tdInput" valign="top">
		          <input type="text" id="clusterName" name="cluster.clusterName" class="input" maxlength="20"/>
		        </td>
        ...
        <s:else>
        	<tr>
         		...
         		<td class="tdInput" valign="top">
         			<s:select list="siteList" listKey="siteId"  listValue="siteName" id="siteId" name="cluster.siteId" 
         				  onchange="addZone(this);" onblur="validNotEmpty(this);"  headerKey="" headerValue="%{getText('common.lable.select')}"/>
         		</td>
         	...
         	<tr>
         		<td class="tdLabel" align="right" valign="top"><s:text name="common.red.point"/><s:text name="resource.cluster.zoneName"/><s:text name="common.lable.point"/> </td>
         		<td class="tdInput" valign="top">
         			<s:select list="zoneList" listKey="zoneId"  listValue="zoneName" id="zoneId" name="cluster.zoneId"   headerKey="" headerValue="%{getText('common.lable.select')}"/>
         		</td>
         		<td class="tdVad" valign="top"><div id="zoneIdTip"></div></td>
         	</tr>
        </s:else>
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="brand" name="cluster.brand" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="manufacturer" name="cluster.manufacturer" class="input" maxlength="20"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="length" name="cluster.length" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="width" name="cluster.width" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="height" name="cluster.height" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="unum" name="cluster.Unum" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="power" name="cluster.power" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td class="tdInput" valign="top">
        			<input type="text" id="size" name="cluster.size" class="input" maxlength="10"/>
        		</td>
        	...
        	<tr>
        		...
        		<td  class="tdInput" valign="top">        
                    <textarea name="cluster.description" id="desc" class="newTextarea" onkeydown="validateTextarea();" onkeyup="validateTextarea();"></textarea>
			     </td>
