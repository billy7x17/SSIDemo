		...
		<div class="rightToolbar">
		 ...
		 <!--内容部分 main star-->
		     <div class="rightDisplayFwSj">
               	 <form id="mainForm" method="post" action="alarmrosterEdit.action?alarmroster.rosterID=<s:property value="alarmroster.rosterID"/>" >
               	   <input type="hidden" name="alarmroster.modifyTime" value="<s:property value="alarmroster.modifyTime"/>"/>
			        ...
			        <tr>
			            ...
			            <td  class="tdInput" valign="top">
			              <select id="type" name="alarmroster.type" class="newSelect" onchange="typeClick()">
			           ...
			           <td class="tdLabel" align="right" valign="top"><strong><s:text name="common.red.point" /><s:text name="alarmroster.alarmGrade"/><s:text name="common.lable.point" /></strong></td>
			            <td  class="tdInput" valign="top" colspan="2">
			              <div style="float:left;">
			               <input  type="radio" id="alarmGrade" name="alarmroster.alarmGrade" value="2" <s:if test="alarmroster.alarmGrade==2">checked</s:if><s:elseif test="alarmroster.alarmGrade==null">checked</s:elseif> /><s:text name="alarmroster.alarmGrade.2"/>
			              </div>
