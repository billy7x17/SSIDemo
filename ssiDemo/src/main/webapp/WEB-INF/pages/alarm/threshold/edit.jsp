...
$(function(){
	...
	//控制业务实例是否展示
	if ('<s:property value="thresholdDomain.typeId"/>' != 20) {
	...
	//控制阀值最大值是否展示
    if ('<s:property value="thresholdDomain.perCondition"/>' == 3) {
    	$("#value2Div").show(); 
    }
...
$(function(){
	...
	$("#thresholdName")
       ...
       //阀值条件
        ...
        //告警标题，增加title属性
        $('option','#tcTitle').attr('title',function(){ 
...
function validateObject(){
      ...
      if(value1 == "" || value1 == null || !reg.test(value1)) { 
          $("#valueTip").html('<s:text name="threshold.js.onshow.thresholdValue" />'); //请输入阈值，必须为数字，最多15个字符
...
function validate(){
	...
	if(agentIdSelect=="0"){
		alert('<s:text name="threshold.throshlodValue2" />');
	}else if(oidSelect=='0'){
		alert('<s:text name="threshold.throshlodValue3" />');
	}else if($("#valueTip").hasClass("onError")){
		$("#valueTip").removeClass();
		$("#valueTip").addClass("onError");
    }else if(formCheck){
        $("#valueTip").html('<s:text name="threshold.js.oncorrect" />'); //正确
	...
	<div class="rightToolbar">
	 ...
	 <!--内容部分 main star-->
	     <div class="rightDisplayFwSj">
                	<form id="mainForm" method="post" action="thresholdEdit.action" >
                	<s:hidden id="alarmIdentityID" name="thresholdDomain.alarmIdentityID" />
                	<input type="hidden" name="id" id="id" value="<s:property value="thresholdDomain.id"/>"/> 
                	<div>
                		<table class="addTable" align="center" cellpadding="0" cellspacing="0" >
                		    <%-- 
		                     <tr>
					            ...
					            <td class="tdInput" valign="top">
					              <s:property value="thresholdDomain.alarmIdentityID"/>
					            </td>
		                     ...
		                     <tr>
					            ...
					            <td class="tdInput" valign="top">
					              <input type="text" id="thresholdName" name="thresholdName" value="<s:property value="thresholdDomain.eventName"/>" class="input" maxlength="32"/>
					            </td>
					         ...
					         <tr>
					            ...
					            <td class="tdInput" valign="top">
			                      <s:select list="deviceListType" listKey="rowId" listValue="agentName" name="agentId" id="agentId" cssClass="newSelect" headerKey="" value="%{thresholdDomain.typeId}" headerValue="%{getText('lable.select')}" onchange="getDeviceOid(this); ">          
			                    </s:select>
					            </td>
			                 ...
			                 <tr class="system">
                                ...
                                <td class="tdInput" valign="top">
                                 <s:select list="systemList" listKey="systemId" listValue="systemName" name="systemId" id="systemId" cssClass="newSelect" value="%{thresholdDomain.systemId}" headerKey="" headerValue="%{getText('lable.select')}" >          
                                </s:select>
                                </td>
					         ...
					         <tr>
                                ...
                                <td class="tdInput" valign="top">
                                   <s:select list="mibList" listKey="mibId" listValue="mibName" name="oid" id="oid" cssClass="newSelect"  onchange="validateObject()" value="%{thresholdDomain.mibId}" headerKey="" headerValue="%{getText('lable.select')}">          
                                 </s:select>
                                </td>
					        ...
					        <tr>
                                ...
                                <td class="tdInput" valign="top">
                                <s:select list="thresholdContentDomainList" listKey="tcId" listValue="tcTitle" name="tcTitle" id="tcTitle" cssClass="newSelect" headerKey="" value="%{thresholdDomain.tcId}" headerValue="%{getText('lable.select')}">          
                                </s:select>
                                </td>
							 ...
							 <tr>
					            ...
					            <td class="tdInput" valign="top">
					              <s:select list="levelList" listKey="levelId" listValue="levelName" name="level" id="level" cssClass="newSelect" value="%{thresholdDomain.level}" headerKey="" headerValue="%{getText('lable.select')}">          
			                    </s:select>
					            </td>
                              ...
                              <tr>
                                ...
                                <td class="tdInput" valign="top">
                                     <s:select list="#{1:'等于',2:'不等于',3:'区间'}" listKey="key" listValue="value" id="perCondition" name="perCondition" cssClass="newSelect" value="%{thresholdDomain.perCondition}" headerKey="" headerValue="%{getText('lable.select')}" onchange="changeCondition(this);">
                                     </s:select>
                                </td>
                             ...
                             <tr>
                                ...
                                <td class="tdInput" valign="top">
                                  ...
                                  <input type="text" id="value" name="value" class="alarmInput" maxlength="15" value="<s:property value="thresholdDomain.value"/>" onblur="validateObject()" style="width:80px;"/>
                                   </div>
                                   <div id="value2Div" style="float:left; margin-left:10px; display:none;">                                                     
                                                                                         至&nbsp;<input type="text" id="value2" name="value2" class="alarmInput" maxlength="15" value="<s:property value="thresholdDomain.value2"/>" onblur="validateObject()" style="width:80px;"/>
                                    </div>
                                </td>
                             ...
                             <tr>
                                    ...
                                    <td  class="tdInput" valign="top">        
                                      <div class="confWrap">
                                                ...
                                                <textarea name="description" id="description" class="newTextarea" onkeydown="validateTextarea('description',200);" onkeyup="validateTextarea('description',200);"><s:property value="thresholdDomain.eventTypeDesc"/></textarea>
                                              </div>
                                    </td>
                            ...
                            <tr>
                                    ...
                                    <td  class="tdInput" valign="top">        
                                      <div class="confWrap">
                                                <label for="textarea"></label>
                                                <textarea name="alarmImpact" id="alarmImpact" class="newTextarea" onkeydown="validateTextarea('alarmImpact',512);" onkeyup="validateTextarea('alarmImpact',512);"><s:property value="thresholdDomain.alarmImpact"/></textarea>
                                              </div>
                                    </td>
