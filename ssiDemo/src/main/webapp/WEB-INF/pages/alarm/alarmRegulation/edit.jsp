...
function addHoverDom(treeId, treeNode) {
    ...
    var addStr = "<button type='button' class='add' id='addBtn_" + treeNode.id
        + "' title=\'<s:text name="common.title.add" />\' onfocus='this.blur();'></button>";
...
function relationRadioHtml(relation){
    ...
    html = html + '</div>';
    html = html + '<div style="float:left; margin-left:10px;">';
...
function validate(){
	...
	if(formCheck){
		$("#mainForm").attr("action","alarmRegulationEdit.action");
		$("#mainForm").submit();
	}else{
		return false;
	}
      ...
      <form id="mainForm" method="post" action="alarmrosterAdd.action" > 
        ...
        <table class="addTable" align="center" cellpadding="0" cellspacing="0" >
          <tr>
            ...
            <td class="tdInput" valign="top" style="width:300px;color: #666;">
              <s:property value="domain.ruleName"/>
            </td>
          ...
          <tr>
             ...
             <td  class="tdInput" valign="top" style="width:300px;">        
                 <textarea name="domain.ruleDesc" id="ruleDesc" class="newTextarea" onkeydown="validateTextarea();" onkeyup="validateTextarea();"><s:property value="domain.ruleDesc"/></textarea>
             </td>
...
<!-- 添加策略节点 -->
 <div id="addRule" style="display:none;"> 
     <table class="addTable" align="center" cellpadding="0" cellspacing="0" border="0">
        <tr>
           <td class="tdLabel" align="right" valign="top"><s:text name="field.label.addType"/><s:text name="common.lable.point" /></td>
         ...
         <tr>
           <td class="tdLabel" align="right" valign="top"><s:text name="common.red.point" /><s:text name="field.label.nodeName"/><s:text name="common.lable.point" /></td>
           <td  class="tdInput" valign="top">        
                <s:textfield name="domain.nameValue" id="nameValue" maxlength="16" cssClass="input" ></s:textfield>
           </td>
           <td class="tdVad" valign="top"><div id="nodeNameTip"></div></td>
        </tr> 
        <tr>
           <td class="tdLabel" align="right" valign="top"><s:text name="field.label.ruleRelation"/><s:text name="common.lable.point" /></td>
           <td  class="tdInput" valign="top" id="relationTd">
