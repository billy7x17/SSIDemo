...
[ExcludeClass]
public class _EditorFacade_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _EditorFacade_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "EditorFacade" : String(params[0]);
...
,
            ...
            mainClassName: "EditorFacade",
            mixins: [ "_EditorFacade_FlexInit", "_EditorFacade_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
            paddingBottom: "0",
            paddingLeft: "0",
            paddingRight: "0",
            paddingTop: "0",
