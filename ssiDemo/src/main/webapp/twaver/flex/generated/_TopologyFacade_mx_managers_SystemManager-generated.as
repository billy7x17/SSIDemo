...
import com.neusoft.mid.common.component.CustomPreloader;

[ExcludeClass]
public class _TopologyFacade_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _TopologyFacade_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "TopologyFacade" : String(params[0]);
...
,
            ...
            compiledResourceBundleNames: [ "collections", "containers", "controls", "core", "effects", "skins", "styles", "utils" ],
            creationComplete: "init();",
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "TopologyFacade",
            mixins: [ "_TopologyFacade_FlexInit", "_TopologyFacade_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
            paddingBottom: "0",
            paddingLeft: "0",
            paddingRight: "0",
            paddingTop: "0",
...
"SHA-256",false,false,"default")]]
,
            preloader: com.neusoft.mid.common.component.CustomPreloader
            }
        }
        return _info;
    }
