...
[Mixin]
public class _EditorFacade_FlexInit
{
   public function _EditorFacade_FlexInit()
   {
       super();
   }
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         ...
                         ["mx.collections.ArrayCollection","EditorFacade","_EditorFacade_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.collections.ArrayList","EditorFacade","_EditorFacade_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.utils.ObjectProxy","EditorFacade","_EditorFacade_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
