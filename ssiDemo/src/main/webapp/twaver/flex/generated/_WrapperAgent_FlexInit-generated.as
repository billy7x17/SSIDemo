...
[Mixin]
public class _WrapperAgent_FlexInit
{
   public function _WrapperAgent_FlexInit()
   {
       super();
   }
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         ...
                         ["mx.collections.ArrayCollection","WrapperAgent","_WrapperAgent_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.collections.ArrayList","WrapperAgent","_WrapperAgent_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.utils.ObjectProxy","WrapperAgent","_WrapperAgent_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
