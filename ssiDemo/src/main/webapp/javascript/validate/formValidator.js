...
$.fn.formValidator = function(cs) 
{
	...
	{
		validatorgroup : "1",
		trim:true,// add by sunwei for word trim
		empty :false,
		submitonce : false,
		automodify : false,
		onshow :"请输入内容",
	...
	return this.each(function(e)
	{
		...
		if(srcTag == "input" || srcTag=="textarea")
		{
			...
			jqobj.bind(setting.triggerevent, function(){
				...
				//先自动trim左右空格 再校验,add by sunwei for auto trim
				var trim = setting.trim && (this.type=="text" || this.type=="textarea" || this.type=="file" || this.type=="password");
				if(trim){
					jqobj.val($.trim(jqobj.val()))
				}
