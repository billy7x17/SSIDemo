 ...
 */
public class alarmrulesDetailAction extends OperationLogAction implements IAuthIdGetter {
    ...
    private static LogService logger = LogService.getLogger(alarmrulesDetailAction.class);
    ...
    public String detail() {
        ...
        try {
           ...
           if(alarmrules==null){
               errorMsg=getText("common.message.detailError")+getText("message.detail.error");
               operationInfo = getText("oplog.detail.error",opParam) + getText("message.detail.error");
               forward="ERROR";
           }
    ...
    public static void setLogger(LogService logger) {
        alarmrulesDetailAction.logger = logger;
    }
