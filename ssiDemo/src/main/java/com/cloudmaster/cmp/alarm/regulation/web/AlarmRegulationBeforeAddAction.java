 ...
 */
public class AlarmRegulationBeforeAddAction extends BaseAction implements IAuthIdGetter {
    ...
    private static LogService logger = LogService.getLogger(AlarmRegulationBeforeAddAction.class);
